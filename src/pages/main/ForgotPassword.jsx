  ...
  return (
    <div className="forgot-password-wrapper">
      <div className="forgot-password-container">
        ...
        {message && (
          <p className={`forgot-password-message ${message.includes('success') || message.includes('sent') ? 'success' : 'error'}`}>
            {message}
          </p>
        )}
        ...
        <div className="back-to-login-container">
          ...
          <button type="button" onClick={() => navigate("/signIn")} className="back-to-login-btn">
            Back to Login
          </button>
        </div>
      </div>
