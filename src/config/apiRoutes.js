 ...
 *
 * All /users/me/ routes use JWT HttpOnly cookie auth — no userId needed.
 */
...
export const API_ROUTES = {
  ...
  AUTH_REQUEST_OTP: '/v1/auth/request-otp',
  ...
  // Analytics (JWT cookie auth — /me/ prefix)
  HISTORY: '/v1/users/me/history',
  WEEKLY_CHART: '/v1/users/me/weekly-chart',
  STREAK: '/v1/users/me/streaks',
  CRITICAL_FACTORS: '/v1/users/me/weekly-factors',
  DAILY_SUGGESTION: '/v1/users/me/daily-suggestions',
};
